...
public class ImageBroadcast extends FloatingLayout {
    ...
    public ImageBroadcast(Context mContext, JSONObject getJson, OnDestroyListener onDestroyListener) {
        ...
        return new FloatingListener() {
            ...
            public void onCreate(View view) {
                ...
                try {
                    ...
                    createImageViewModal(viewGroup);
    ...
    private void createImageViewModal(ViewGroup viewGroup) throws JSONException {
